...
class GenerationMap extends ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['generation_id', 'ref_generation_id'], 'unique', 'targetAttribute' => ['generation_id', 'ref_generation_id']],
            [['generation_id'], 'exist', 'skipOnError' => true, 'targetClass' => Generation::class, 'targetAttribute' => ['generation_id' => 'id']],
            [['ref_generation_id'], 'exist', 'skipOnError' => true, 'targetClass' => RefGeneration::class, 'targetAttribute' => ['ref_generation_id' => 'id_car_generation']],
        ];
    }
